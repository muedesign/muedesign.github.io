// Scan and display available WiFi networks with their signal strengths on a HTML Webpage
...
void setup() {
  ...
  WiFi.softAP("ESP32S3-WiFiManager", "12345678");
