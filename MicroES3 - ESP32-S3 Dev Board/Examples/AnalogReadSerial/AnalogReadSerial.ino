...
const int analogPin = 4; //  ADC-capable GPIO pin on the board. Connect the analog signal to GPIO 4. Edit this pin if needed by looking at the pinout details given for the board in the GITHUB page.
int sensorValue = 0;
